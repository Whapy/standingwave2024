...
def update_parameters_with_phase(phase_shift1, phase_shift2):
    ...
    # Call draw_wave with the updated phase shift values
...
def update_parameters(*args):
    ...
    # Since we're redrawing the entire figure when updating parameters,
    # simply call update_parameters_with_phase without actual phase change
...
ani = FuncAnimation(fig, animate, frames=50000, interval=0.1, repeat=True)  # frames 是帧率，interval 是每帧间隔时间
